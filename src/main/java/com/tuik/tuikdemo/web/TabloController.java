...
public interface TabloController {
	...
	@PostMapping
	ResponseEntity<?> createTablo(@Valid @RequestBody TabloDTO tabloDTO) throws Exception;
	...
	@PutMapping
	ResponseEntity<?> updateTablo(@Valid @RequestBody TabloDTO tabloDTO) throws Exception;
